  ...
  return (
    <footer className="bg-black border-t border-white/10 relative z-20">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-8">
          ...
          {/* THE LIVE TERMINAL */}
          <div className="w-full bg-[#050505] border border-white/10 p-4 font-mono text-[8px] md:text-[10px] text-green-500 h-32 overflow-hidden relative shadow-inner shadow-black/50 rounded-none mb-8">
